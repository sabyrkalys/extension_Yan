...
// ─────────────────────────────────────────────────────────────────
// ПОДРАЗДЕЛЕНИЯ — дублируют config.js
// Добавить подразделение: одна запись здесь и в config.js клиента
// ─────────────────────────────────────────────────────────────────
const OFFICES = {
  'HQ': {
    name:  'КМП',
  ...
  // Шаблон:
  // 'oXXX': { name: 'XXX подразделение', short: 'XXX', isHQ: false, roles: [...VALID_ROLES] },
};
