...
//
// Добавить новый офис: одна запись в OFFICES.
...
// ОФИСЫ И БОЙЦЫ
//
// isHQ: true  → может ставить задачи любому офису
// isHQ: false → только внутри своего офиса (или принимать от ГО)
//
// Добавить офис:  одна запись здесь + запись в server.js OFFICES
// Добавить бойца: одна строка в roles нужного офиса
// ─────────────────────────────────────────────────────────────────
...
const OFFICES = {
  ...
  // Шаблон нового офиса:
  // 'o3bat': {
  //   name: '3-й батальон', short: '3 бат.', isHQ: false,
  //   roles: { 'админ': ['user_MP'], ... }
  // },
};
...
// Все роли (из HQ, они одинаковы для всех офисов)
